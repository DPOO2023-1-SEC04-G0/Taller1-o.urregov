...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar país del atleta");
	...
	/**
	 * Le pide al usuario el nombre de un atleta y muestra su país
	 */
	private void ejecutarPaisDeAtleta()
	{
		...
		{
			System.out.println("El pais del atleta es: " + pais.darNombre());
		}
	}
